// VERSAO OLIVO - COM AS MODIFICACOES PARA O SISTEMA DO RPi...
...
char INSERT_SQL[] = "INSERT INTO agrotech_intel.dia_clima SET mac='%s', d_T='%s', d_U='%s', b_P='%s', hora=CURRENT_TIME, dia=CURRENT_DATE";
...
sprintf(query, INSERT_SQL, MAC, ST_bme, SU_bme, SP_bme);
//char INSERT_SQL[] = "INSERT INTO agrotech_intel.dia_clima SET mac='%s', bme_U='%s', bme_T='%s', bme_P='%s', bme_cnt=%s, hora=CURRENT_TIME, dia=CURRENT_DATE";
