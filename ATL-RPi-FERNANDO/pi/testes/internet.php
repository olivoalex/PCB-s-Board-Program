...
//
   ...
   if ( $_stm ) {
     echo 'ok';
      ...
      $_log = 'Falha em {$_hoje} as {$_as} ao Logar entrada no MySQL - INTERNET - Status -> {$_internet}\n';
      file_put_contents ('~pi/testes/internet.log', $_log, FILE_APPEND);  
   }
?>