...
$setratePWM100 = shell_exec("/usr/local/bin/gpio -g pwm 18 1023");	// 1023 = 100%
$setratePWM075 = shell_exec("/usr/local/bin/gpio -g pwm 18 768");	// 768 = 75%
$setratePWM050 = shell_exec("/usr/local/bin/gpio -g pwm 18 512");	// 512 = 50%
$setratePWM025 = shell_exec("/usr/local/bin/gpio -g pwm 18 256");	// 256 = 25%
$setratePWM000 = shell_exec("/usr/local/bin/gpio -g pwm 18 0");		// 0 = 0%
// STARTS PWM WORK
echo "{$setSPACER}";
...
//	$setratePWM =  shell_exec("/usr/local/bin/gpio -g pwm 18 1023");	// CORRIGIR PARA 100%
	echo "<br>RAZAO CICLICA PWM = " . 1023*100/1023 . "%" . "{$setratePWM100}";}
...
//	$setratePWM =  shell_exec("/usr/local/bin/gpio -g pwm 18 1023");	// CORRIGIR PARA 50%
	echo "<br>RAZAO CICLICA PWM = " . 512*100/1023 . "%" . "{$setratePWM050}";}
