      ...
      return "<!-- Control Sidebar -->
            ...
            <!-- Create the tabs -->
              <ul class='nav nav-tabs nav-justified control-sidebar-tabs'>
               ...
               <li><a href='#control-sidebar-user-tab' data-toggle='tab'><i class='fa fa-users'></i></a></li>
               <li><a href='#control-sidebar-info-tab' data-toggle='tab'><i class='fa fa-envelope-o'></i></a></li>
              </ul>
              <!-- Tab panes --> 
              <div class='tab-content'>
               <!-- Home tab content --> 
                ...
                <div class='tab-pane' id='control-sidebar-settings-tab'>
      		    ...
      		    <!-- Informacao tab content -->
                <div class='tab-pane' id='control-sidebar-user-tab'>
      		      <h3 class='control-sidebar-heading'>Informações Usuário</h3>
                  <ul class='control-sidebar-menu'>
                    <li>
                      <a href='javascript::;'>
                        <h4 class='control-sidebar-subheading'>
                ...
                <div class='tab-pane' id='control-sidebar-info-tab'>
      		      <h3 class='control-sidebar-heading'>Notificações</h3>
                  <ul class='control-sidebar-menu'>
                    <li>
                      <a href='javascript::;'>
                        <h4 class='control-sidebar-subheading'>
