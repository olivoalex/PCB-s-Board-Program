<?php
   class appm000400_AJAX extends Controller {
	   public $_system; 
       ...
       public function index_action() {
		   ...
		   //-- Identificacao do Tela a ser processada
		   $this->_system->_dados['tel_nome']           = "Ajax appm000400";
		   $this->_system->_dados['tel_titulo']         = "RaspBerryPI";
		   ...
		   $this->loadJSON('appm000400',$this->_system->_dados);
	   }	
