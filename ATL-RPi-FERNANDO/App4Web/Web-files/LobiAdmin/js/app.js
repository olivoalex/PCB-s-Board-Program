...
$(function(){
    ...
    LobiAdmin.DEFAULT_COLOR   = '#2E8B57'; // Verde
	LobiAdmin.DEFAULT_COLOR_1 = '#FF4500'; // Orange Red
	LobiAdmin.DEFAULT_COLOR_2 = '#4682B4'; // Steel Blue
	LobiAdmin.DEFAULT_COLOR_3 = '#A52A2A'; // Brown
    ...
    Lobibox.notify.OPTIONS = $.extend({}, Lobibox.notify.OPTIONS, {
        soundPath: 'http://11.12.13.30/App4Web/Sounds/'
    });
...
function initSparklineDefaults(){
    ...
    var DEFAULT_COLOR = LobiAdmin.DEFAULT_COLOR;    // Verde
    var DEFAULT_COLOR_1 = LobiAdmin.DEFAULT_COLOR_1; // Orange Red
	var DEFAULT_COLOR_2 = LobiAdmin.DEFAULT_COLOR_2; // Steel Blue
	var DEFAULT_COLOR_3 = LobiAdmin.DEFAULT_COLOR_3; // Brown
    ...
    $.fn.sparkline.defaults.line.highlightLineColor = DEFAULT_COLOR_1;
    $.fn.sparkline.defaults.line.defaultPixelsPerValue = '9';
    $.fn.sparkline.defaults.line.spotRadius = '2.5';
    
    //bar chart options
    $.fn.sparkline.defaults.bar.barColor = DEFAULT_COLOR_2;
    $.fn.sparkline.defaults.bar.barWidth = 10;
    
    //pie chart defaults
    $.fn.sparkline.defaults.pie.sliceColors = [LobiAdmin.lightenColor(DEFAULT_COLOR, -17),
                                                DEFAULT_COLOR_1,
                                                LobiAdmin.lightenColor(DEFAULT_COLOR_2, 17),
                                                LobiAdmin.lightenColor(DEFAULT_COLOR_3, 34),
                                                LobiAdmin.lightenColor(DEFAULT_COLOR_1, 51),
                                                LobiAdmin.lightenColor(DEFAULT_COLOR_2, 68)
                                                ];
