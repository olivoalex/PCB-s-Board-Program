window.LobiAdminConfig = {
    ...
    weekNames                       : ["Domingo", "Segunda-feira", "Terça-feira", "Quarta-feira", "Quinta-feira", "Sexta-feira", "Sabado"],
    ...
    error404Page                    : 'App4Web/Pages/error-404.html',
    ...
    error500                        : 'App4Web/Pages/error-500.html',
...
//    '(dashboard|calendar|profile)': 'pages/$1.html',
	'(.phtml)' : 'Views/$1',
	'(.php)' : 'Pages/$1',
    '(.+)' : 'HTML/$1.html'	// atendes #teste -> pages/teste.html _ fazendo essa regra ser um default
