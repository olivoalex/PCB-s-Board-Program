<?php
   ...
   class ADMm000200 extends Controller {      	   
     ...
     public function init($_start) {
   	 ...
   	 public function index_action() {
   	 	...
   	 	$LINK_MODULO = "{$this->_system->_link}admm000200/index/{$MODULO}/";
		
   	 	$this->_system->_dados['modulo'] = $MODULO;
   	 	$this->_system->_dados['link_modulo'] = $LINK_MODULO;
		
   	 	//-- Identificacao do Tela a ser processada
   	 	$this->_system->_dados['tel_nome']           = "Data/Hora/Alarme";
   	 	$this->_system->_dados['tel_titulo']         = "Data/Hora/Alarme";
   	 	$this->_system->_dados['tel_id']             = "0";
   	 	$this->_system->_dados['tel_cod']            = "admm000200";
        ...
        $this->_system->_dados['page_content'] = "ADMM000200 - Data/Hora/Alarme";
		...
		$this->_system->loadToDados($_programa_dados);
   	 	...
   	 	// Carrega Visao
		$_view = ( $_programa_dados["prg_view"] != "NONE" ? $_programa_dados["prg_view"] : "admm000200.phtml" );
