<?php
   ...
   class CALm000100 extends Controller {      	   
     ...
     public function init($_start) {
   	 ...
   	 public function index_action() {
   	 	...
   	 	$LINK_MODULO = "{$this->_system->_link}calm000100/index/{$MODULO}/";
		
   	 	$this->_system->_dados['modulo'] = $MODULO;
   	 	$this->_system->_dados['link_modulo'] = $LINK_MODULO;
		
   	 	//-- Identificacao do Tela a ser processada
   	 	$this->_system->_dados['tel_nome']           = "Calendário";
   	 	$this->_system->_dados['tel_titulo']         = "Calendário";
   	 	$this->_system->_dados['tel_id']             = "0";
   	 	$this->_system->_dados['tel_cod']            = "calm000100";
        ...
        $this->_system->_dados['page_content'] = "CALM000100 - Calendário";
		...
		$this->_system->loadToDados($_programa_dados);
   	 	...
   	 	// Carrega Visao
		$_view = ( $_programa_dados["prg_view"] != "NONE" ? $_programa_dados["prg_view"] : "calm000100.phtml" );
