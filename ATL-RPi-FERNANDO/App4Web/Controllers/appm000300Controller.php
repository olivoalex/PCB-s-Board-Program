<?php
   ...
   class APPm000300 extends Controller {      	   
     ...
     public function init($_start) {
        ...
        $this->_system->_dados['page_content'] = "APPM000300 - Estação Climática";
		...
		//print_r($_programa_dados);
   	 	...
   	 	// Carrega Visao
		$_view = ( $_programa_dados["prg_view"] != "NONE" ? $_programa_dados["prg_view"] : "appm000300.phtml" );
	    ...
	    //echo "<br>Tarefa EXEC no controller appm000300";
